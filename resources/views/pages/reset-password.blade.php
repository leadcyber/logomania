                        ...
                        <div class="row gy-3">
                            <div class="col-xl-12 mt-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-light" onclick="createpassword('reset-password',this)"
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="input-group">
                                    <input type="password" class="form-control form-control-lg" id="reset-newpassword"
                                        placeholder="new password">
                                    <button class="btn btn-light" onclick="createpassword('reset-newpassword',this)"
                            ...
                            <div class="col-xl-12 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <button class="btn btn-light" onclick="createpassword('reset-confirmpassword',this)"
                                        type="button" id="button-addon22"><i
                                            class="ri-eye-off-line align-middle"></i></button>
                                </div>
                                <div class="mt-2">
                            ...
                            <div class="col-xl-12 d-grid mt-2">
                                <a href="{{ url('/signup') }}" class="btn btn-lg btn-primary">Create</a>
                            </div>
                        </div>
