...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4">
                        <div class="text-end landing-main-image landing-heading-img">
                            <img src="{{ asset('build/assets/images/media/landing/1.png') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                </div>
    ...
    <section class="section section-bg " id="statistics">
        <div class="container text-center position-relative">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7">
                    <p class="text-muted fs-15 mb-5 fw-normal">We are proud to have top class clients and customers,which
    ...
    <section class="section " id="about">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7">
                    <p class="text-muted fs-15 mb-3 fw-normal">ynex comes with multiple customization options that are very
                        easy to implement.</p>
                </div>
            </div>
            <div class="row justify-content-between align-items-center mx-0">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 pt-5 pb-0 px-lg-2 px-5 text-start">
                    ...
                    <p class=" text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or damsenlel verman
    ...
    <section class="section section-bg " id="our-mission">
        <div class="container text-center">
            ...
            <div class="row justify-content-center mb-5">
                <div class="col-xl-7">
                    <p class="text-muted fs-15mb-0 fw-normal">Our mission is to make web design easy, so you can focus on
                        ...
                        <div class="card-body">
                            <div class="align-items-top">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-muted">lorem ipsum, dolor sit var ameto condesetrat aiatel varen or
                                        damsenlel verman code Lorem ipsum, dolor sit amet consectetur adipisicing elit</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="justify-content-center">
                    <div class="">
                        <div class="feature-logos mt-sm-5 flex-wrap">
                            ...
                            <div class="ms-sm-5 ms-2 text-center">
                                <img src="{{ asset('build/assets/images/media/landing/web/6.png') }}" alt="image"
                                    class="featur-icon">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <span class="text-muted">- Lorem ipsum dolor sit amet consectetur adipisicing elit.
                                        Earum autem quaerat distinctio --</span>
                                </div>
    ...
    <section class="section  " id="pricing">
        <div class="container text-center">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-9">
                    <p class="text-muted fs-15 mb-5 fw-normal">Our plans are most affordable and are mainly placed by
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6 col-12 mb-md-0 mb-3">
                    <div class="px-4">
                        <p class="fw-semibold mb-3"><a href="{{ url('/') }}"><img
                                    src="{{ asset('build/assets/images/brand-logos/desktop-dark.png') }}"
                                    alt=""></a></p>
