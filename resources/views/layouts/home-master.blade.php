...
<html lang="en" dir="ltr" data-nav-layout="horizontal" data-nav-style="menu-click" data-menu-position="fixed" data-theme-mode="light">
    ...
    <head>
        ...
        @include('layouts.components.home.styles')
    ...
    <body class="landing-body">
        ...
        @include('layouts.components.home.switcher')
		...
		<div class="landing-page-wrapper">
            ...
            @include('layouts.components.home.header')

            <!-- END HEADER -->

            <!-- SIDEBAR -->

            @include('layouts.components.home.sidebar')
            ...
            <div class="main-content landing-main">
                ...
                @yield('content')
                    ...
                    <!-- FOOTER -->
                    @include('layouts.components.home.footer')
        ...
        @include('layouts.components.home.scripts')
